...
public class CreditRatingType
    ...
    */
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":CreditRatingType",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "CreditRatingType",
    ...
    public static class Factory {
         ...
         */
        public static CreditRatingType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            CreditRatingType object =
                    new CreditRatingType();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"CreditRatingType".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (CreditRatingType) org.wso2.bps.samples.creditrating.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://wso2.org/bps/samples/loan_process/schema", "rating").equals(reader.getName())) {
