...
public class BpelProcessManagementTest extends BPSMasterTest {
    ...
    org.wso2.carbon.automation.api.clients.bpel.BpelProcessManagementClient bpelProcessManagementClient;
    ...
    public void setEnvironment() throws LoginAuthenticationExceptionException, RemoteException {
        ...
        bpelProcessManagementClient = new org.wso2.carbon.automation.api.clients.bpel.BpelProcessManagementClient(backEndUrl, sessionCookie);
