...
<head>
    ...
    <title>WSO2 Stratos Business Process Server</title>
...
<fmt:bundle basename="org.wso2.carbon.i18n.Resources">
    ...
    <div id="login-content">
        <div class="main-text">
            The WSO2 Business Process Server, powered by Apache ODE and providing a complete
            graphical console to deploy, manage and view processes and process instances, delivered
        ...
        <div class="feature feature-left">
            ...
            <h2>WS-BPL 2.0 & BPELWS 1.1</h2>

            <p>
                WSO2 BPS supports both WS-BPEL 2.0 and BPEL4WS 1.1 standards. In addition to that
                there are WSO2 BPS specific extensions which enhance the features provide by
                WS-BPEL.
            </p>
        </div>
        <div class="feature">
            ...
            <h2>Secured Business Processers</h2>

            <p>
                WSO2 BPS provides support for securing business processes as well as invoking
                secured partner services from BPEL processes.
            </p>
        </div>
        <div class="feature">
            ...
            <p>
                WSO2 Business Process Server Management Console allows real time monitoring of
                business processes
            </p>
        </div>
        <div class="clear"></div>
                            ...
                            <tr>
                                <td class="user_pass_td">
                                    ...
                                    <form action='../admin/login_action.jsp' method="POST"
                                        ...
                                        <input type="hidden" id="txtbackendURL" name="backendURL"
                                               class="user" tabindex="1" value="<%=backendURL%>"/>
                                        <table class="user_pass_table">
                                            <tr>
                                                <td><label for="txtUserName"><fmt:message
                                                        key="username"/></label></td>
                                                <td><input type="text" id="txtUserName"
                                                           name="username"
                                                           tabindex="1"/> <%=tenantdomain%>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td></td>
                                            ...
                                            <tr>
                                                <td><label for="txtPassword"><fmt:message
                                            ...
                                            <tr>
                                                <td colspan="2">
                                                    If your organization doesn't have an account,
                                                    please <a href="<%=registerPath%>"
                                                              alt="Go To Register Page">register</a>.
                                                </td>
                                            </tr>
                                            <%
                                                }
                                            %>
                                            <tr>
                                                <td colspan="2"><a class="help" target="_blank"
                                                                   href="../tenant-login/docs/userguide.html"
                                                                   tabindex="4"><fmt:message
                                                        key="sign.in.help"/></a>
                                                    &nbsp;|&nbsp;<a tabindex="5"
                                                                    href="../admin-mgt/forgot_password.jsp"
                                                                    target="_blank"
                                                                    class="password"><fmt:message
                                ...
                                <td class="google-app-td">
                                    ...
                                    <div id="loginBoxGoogle">
                                        ...
                                        <form action="../relyingparty/openid.jsp"
                                              name="googleAppLogin"
                                              method="POST">
                                            <table class="styledLeft noBorders">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input type="button" class="button"
                                                               ...
                                                               onclick="document.googleAppLogin.submit()"/>
                                                    </td>
                                                </tr>
                                                </tbody>
                                            </table>
        ...
        <div id="footer">
            <div class="powered">
                <span>Powered by</span><a target="_blank" href="http://wso2.org/projects/bps"><img
                    src="../tenant-login/images/powered.gif"/></a>
            </div>
            &copy; appserver.stratoslive.wso2.com copyright 2010 WSO2, Inc. &nbsp;
            <a target="_blank" href="http://www.wso2.com/cloud/services/terms-of-use">Terms of
                                                                                      Service</a>
                   |
            <a target="_blank" href="http://www.wso2.com/cloud/services/privacy-policy">Privacy
                                                                                        Policy</a>
                   |
