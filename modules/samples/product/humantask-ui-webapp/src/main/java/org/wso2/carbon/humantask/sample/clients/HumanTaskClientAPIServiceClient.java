...
public class HumanTaskClientAPIServiceClient {
	...
	public TTaskSimpleQueryResultSet taskListQuery(TSimpleQueryInput queryInput)
		...
		try {
			...
			log.error(
					"Error occurred while performing taskListQuery operation",
					e);
			throw e;
	 ...
	 *             :
	 */
	public TTaskAbstract loadTask(URI taskId) throws RemoteException,
			IllegalAccessFault {
		...
		try {
			...
			log.error("Error occurred while performing loadTask operation",
					illegalAccessFault);
			throw illegalAccessFault;
		}
	}

	public boolean addAttachment(String taskID, String attachmentName,
			String contentType, String attachmentID) throws RemoteException,
			IllegalStateFault, IllegalOperationFault, IllegalArgumentFault,
			IllegalAccessFault, URI.MalformedURIException {
		String errorMsg = "Error occurred while performing addAttachment operation.";
		try {
			// TODO :
			// "Some of the attributes(like accessType) defined in the Service WSDLs are ignored and nulls are "
			// +
			// "passed from to the service call");
			return stub.addAttachment(new URI(taskID), attachmentName,
					"dummyAccessType", contentType, attachmentID);
		} catch (RemoteException e) {
	...
	public TAttachmentInfo[] getAttachmentInfos(URI taskId)
			throws RemoteException, IllegalStateFault, IllegalOperationFault,
	 ...
	 *             :
	 */
	public void complete(URI taskId, String payLoad) throws RemoteException,
			IllegalAccessFault, IllegalArgumentFault, IllegalStateFault,
	 ...
	 *             :
	 */
	public OMElement loadTaskInput(URI taskId) throws RemoteException,
	 ...
	 *             :
	 */
	public OMElement loadTaskOutput(URI taskId) throws RemoteException,
			IllegalStateFault, IllegalOperationFault, IllegalAccessFault,
			IllegalArgumentFault, XMLStreamException {
	 ...
	 *             :
	 */
	public void claim(URI taskId) throws IllegalArgumentFault,
			IllegalAccessFault, IllegalStateFault, RemoteException,
	...
	public void start(URI taskId) throws RemoteException, IllegalStateFault,
	 ...
	 *             :
	 */
	public void stop(URI taskId) throws RemoteException, IllegalStateFault,
			IllegalOperationFault, IllegalArgumentFault, IllegalAccessFault {
	 ...
	 *             :
	 */
	public void release(URI taskId) throws RemoteException, IllegalStateFault,
			IllegalOperationFault, IllegalArgumentFault, IllegalAccessFault {
	 ...
	 *             :
	 */
	public TTaskEvents getTaskEvents(URI taskId) throws RemoteException,
			IllegalStateFault, IllegalOperationFault, IllegalArgumentFault,
			IllegalAccessFault {
		try {
			return stub.loadTaskEvents(taskId);
		} catch (RemoteException e) {
			log.error("Error occurred while performing get comments operation",
					e);
			throw e;
		} catch (IllegalStateFault e) {
			log.error("Error occurred while performing get comments operation",
	 ...
	 *             :
	 */
	public TComment[] getComments(URI taskId) throws RemoteException,
			IllegalStateFault, IllegalOperationFault, IllegalArgumentFault,
			IllegalAccessFault {
	 ...
	 * 
	 * @param taskId
	 *            : The task which the comment belongs to.
	 * @param commentId
	 ...
	 *             :
	 */
	public void suspend(URI taskId) throws RemoteException, IllegalStateFault,
			IllegalOperationFault, IllegalArgumentFault, IllegalAccessFault {
	 ...
	 *             :
	 */
	public void resume(URI taskId) throws RemoteException, IllegalStateFault,
			IllegalOperationFault, IllegalArgumentFault, IllegalAccessFault {
	 ...
	 *             :
	 */
	public TUser[] getTaskAssignableUsers(URI taskId) throws RemoteException,
			IllegalStateFault, IllegalOperationFault, IllegalArgumentFault {
	 ...
	 * 
	 * @param taskId
	 *            : the task id of the task being delegated.
	 * @param delegatee
	 ...
	 *             :
	 */
	public void delegate(URI taskId, String delegatee) throws RemoteException,
			IllegalStateFault, IllegalArgumentFault, IllegalOperationFault,
			RecipientNotAllowedException, IllegalAccessFault {

		if (delegatee == null || "".equals(delegatee.trim())) {
			throw new IllegalArgumentException(
					"Delegatee user name should not be empty.");
		}
	 ...
	 *             :
	 */
	public void skip(URI taskId) throws IllegalArgumentFault,
			IllegalOperationFault, IllegalAccessFault, IllegalStateFault,
			RemoteException {
	 ...
	 * 
	 * @param taskId
	 *            : The id of the task to be failed.
	 * @throws IllegalArgumentFault
	 *             :
	 * @throws IllegalOperationFault
	 *             :
	 ...
	 *             :
	 */
	public void fail(URI taskId) throws IllegalArgumentFault,
			IllegalOperationFault, IllegalAccessFault, IllegalStateFault,
			RemoteException {
	 ...
	 *             :
	 */
	public void remove(URI taskId) throws IllegalArgumentFault,
			IllegalOperationFault, IllegalAccessFault, RemoteException {
		String errMsg = "Error occurred while performing resume operation";
		try {
			stub.remove(taskId);
		} catch (RemoteException e) {
	...
	public void changePriority(URI taskId, int priorityInt)
			...
			IllegalAccessFault, RemoteException, IllegalStateFault {
